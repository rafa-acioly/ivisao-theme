  ...
  <div class="hero-side-menu">
    <div class="hero-menu-item">
      ...
      <div class="hero-menu-content has-text-centered">
        <h2 class="title is-5">Área médica</h2>
        <h3 class="subtitle is-6">Área restrira para profissionais</h3>
      </div>
    </div>
    <div class="hero-menu-item">
      <div class="hero-menu-img">
      ...
      <div class="hero-menu-content has-text-centered">
        <h2 class="title is-5">Pré-agendamento</h2>
        <h3 class="subtitle is-6">Consulta e exames</h3>
      </div>
    </div>
  </div>
  <figure>
    <img src="https://source.unsplash.com/collection/1128928/1600x900" alt="">
  </figure>
</main>
